...
<div class="loginBox">
	...
	<form action="dologin.jsp" method="post" >
		<ul class="login">
			<li class="l_tit">用户名/邮箱/手机号</li>
			<li class="mb_10"><input type="text" class="login_input user_icon" name="username" value="" placeholder="Username"></li>
			<li class="l_tit">密码</li>
			<li class="mb_10"><input type="password" class="login_input user_icon" name="password" value="" placeholder="Password"></li>
