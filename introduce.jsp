...
<div class="headerBar">
	<div class="topBar">
		<div class="comWidth">
			<div class="leftArea">
				<a href="#" class="collection">收藏Clementine电商</a>
			</div>
			<div class="rightArea">
				欢迎来到Clementine电商网！<a href="login.jsp">[登录]</a><a href="register.jsp">[免费注册]</a>
			</div>
		</div>
	</div>
	<div class="logoBar">
		<div class="comWidth">
			<div class="logo fl">
				<a href="#"><img src="images/logo.jpg" alt="Clementine电商网"></a>
			</div>
...
产批次不同混合发货</h3>
				<div class="dl clearfix">
					<div class="dt">Clementine电商价</div>
			...
			<div class="review_listBox">
				<div class="review_list clearfix">
					...
					<div class="review_cont">
						...
						<p>赖Clementine电商挺不错的信赖Clementine电商挺不错的，信赖Clementine电商</p>
